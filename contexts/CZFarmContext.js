...
export const CZFarmProvider = ({ children }) => {
  ...
  const {
    ...
    farmsV2TvlWei,
    poolsV1TvlWei
  } = useTvlWei(czfPrice,czusdPrice,chronoVestingsTotalVesting,poolsV1TokenBalance,v2FarmsLpBal,lpInfos);

  return (
    <CZFarmContext.Provider value={{czusdPrice,czfPrice,bnbPrice,deapPrice,chronoVestingsTotalVesting,poolsV1TokenBalance,v2FarmsLpBal,lpInfos,chronoTvlWei,exoticTvlWei,farmsV2TvlWei,poolsV1TvlWei,
