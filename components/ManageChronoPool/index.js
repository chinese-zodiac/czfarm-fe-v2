  ...
  <CollapsibleCard className="mb-3" key={pool.pid} 
    ...
    <div className="is-flex is-flex-direction-row is-flex-wrap-wrap">
      ...
      <div className="is-inline-block p-3 m-3 is-align-self-stretch" style={{border:"solid 1px #dbdbdb",maxWidth:"25em"}}>
        ...
        <p>You will get {weiToShortString(BigNumber.from(poolAccountInfo?.totalVesting ?? 0).mul(BigNumber.from(10000).add(poolInfo?.ffBasis ?? 0)).div(10000),3)} CZF immediately.</p>
      </div>
